...
public abstract class AbstractInstrumentation extends Instrumenter.Default {
  ...
  public ElementMatcher<ClassLoader> classLoaderMatcher() {
    ...
    return hasClassesNamed("unshaded.io.opentelemetry.context.propagation.ContextPropagators")
        // and this class was introduced in OpenTelemetry API 0.4
        .and(not(hasClassesNamed("unshaded.io.opentelemetry.internal.Obfuscated")));
  }
