 ...
 */
package io.opentelemetry.auto.instrumentation.opentelemetryapi.v0_4.trace;

import io.opentelemetry.auto.bootstrap.ContextStore;
import io.opentelemetry.auto.instrumentation.opentelemetryapi.v0_4.context.NoopScope;
import io.opentelemetry.auto.instrumentation.opentelemetryapi.v0_4.context.UnshadedScope;
...
public class TracingContextUtils {
  ...
  public static Context withSpan(
    ...
    final io.opentelemetry.trace.Span shadedSpan = Bridging.toShadedOrNull(span);
    if (shadedSpan == null) {
  ...
  public static Span getCurrentSpan() {
    return Bridging.toUnshaded(io.opentelemetry.trace.TracingContextUtils.getCurrentSpan());
  }
  ...
  public static Span getSpan(
    ...
    return Bridging.toUnshaded(io.opentelemetry.trace.TracingContextUtils.getSpan(shadedContext));
  }
  ...
  public static Span getSpanWithoutDefault(
    ...
    return shadedSpan == null ? null : Bridging.toUnshaded(shadedSpan);
  }
